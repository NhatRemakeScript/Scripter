...
hpLabel.Size = UDim2.new(0, 150, 0, 25)
...
hpStroke.Color = Color3.fromRGB(0, 255, 0)
    ...
    if silentAimEnabled then
        pcall(function()
            ...
            if target and target:FindFirstChild("HumanoidRootPart") and target:FindFirstChild("Humanoid") then
                ...
                if head then
                    targetPosition = head.Position + Vector3.new(0, 1.5, 0)
                else
                    targetPosition = target.HumanoidRootPart.Position + Vector3.new(0, 3, 0)
                end
                ...
                if onScreen then
                    ...
                    hpLabel.Position = UDim2.new(0, screenPosition.X - 75, 0, screenPosition.Y - 15)
                    
                    local health = math.floor(target.Humanoid.Health)
                    local maxHealth = math.floor(target.Humanoid.MaxHealth)
                    local healthPercent = target.Humanoid.Health / target.Humanoid.MaxHealth
                    
                    hpLabel.Text = target.Parent.Name .. " " .. health .. "/" .. maxHealth .. " HP"
                    
                    if healthPercent > 0.5 then
                        hpStroke.Color = Color3.fromRGB(0, 255, 0)
                    elseif healthPercent > 0.25 then
                        hpStroke.Color = Color3.fromRGB(255, 255, 0)
                    else
                        hpStroke.Color = Color3.fromRGB(255, 0, 0)
                    end
                else
                    hpLabel.Visible = false
                end
