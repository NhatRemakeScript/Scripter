...
targetBox.Size = UDim2.new(0, 50, 0, 70)
...
targetBoxStroke.Color = Color3.fromRGB(0, 255, 0)
targetBoxStroke.Thickness = 3
    ...
    if silentAimEnabled and currentTarget then
        pcall(function()
            if currentTarget and currentTarget:FindFirstChild("HumanoidRootPart") and currentTarget:FindFirstChild("Humanoid") then
                ...
                if onScreen then
                    targetBox.Position = UDim2.new(0, screenPosition.X - 25, 0, screenPosition.Y - 35)
                    
                    local healthPercent = currentTarget.Humanoid.Health / currentTarget.Humanoid.MaxHealth
                    if healthPercent > 0.5 then
                        targetBoxStroke.Color = Color3.fromRGB(0, 255, 0)
                    elseif healthPercent > 0.25 then
                        targetBoxStroke.Color = Color3.fromRGB(255, 255, 0)
                    else
                        targetBoxStroke.Color = Color3.fromRGB(255, 0, 0)
                    end
                    
                    healthLabel.Text = currentTarget.Parent.Name .. " | " .. math.floor(currentTarget.Humanoid.Health) .. " HP"
                else
                    targetBox.Visible = false
                end
            else
